    ...
    return (
        <div className="min-h-screen bg-background py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto bg-card p-8 shadow rounded-lg">
                ...
                <h1 className="text-3xl font-bold text-foreground mb-6">服務條款 (Terms of Service)</h1>
                ...
                <div className="prose prose-blue max-w-none text-gray-600 space-y-4">
                    ...
                    <h2 className="text-xl font-semibold text-foreground mt-6">2. 服務內容</h2>
                    <p>
                        本服務提供地壺球比賽的數位化計分、數據記錄、家屬查詢及相關社群功能。
                        我們保留隨時修改、暫停或終止部分或全部服務的權利。
                    </p>

                    <h2 className="text-xl font-semibold text-foreground mt-6">3. 帳號規範</h2>
                    ...
                    <h2 className="text-xl font-semibold text-foreground mt-6">4. 使用者行為</h2>
                    ...
                    <h2 className="text-xl font-semibold text-foreground mt-6">6. 免責聲明</h2>
                    <p>
                        本服務按「現狀」提供，不保證服務不會中斷或無錯誤。
                        對於因使用本服務而產生的任何直接或間接損害，我們不承擔賠償責任，除非法律另有規定。
                    </p>

                    <h2 className="text-xl font-semibold text-foreground mt-6">7. 適用法律</h2>
                    <p>
