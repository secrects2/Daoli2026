...
export default function PrivacyPolicyPage() {
    return (
        <div className="min-h-screen bg-background py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto bg-card p-8 shadow rounded-lg">
                <div className="mb-8">
                ...
                <h1 className="text-3xl font-bold text-foreground mb-6">隱私權政策 (Privacy Policy)</h1>

                <div className="prose prose-blue max-w-none text-gray-600 space-y-4">
                    <p className="text-sm text-muted-foreground">最後更新日期：2026年1月31日</p>
                    ...
                    <h2 className="text-xl font-semibold text-foreground mt-6">2. 我們收集的資訊</h2>
                    ...
                    <h2 className="text-xl font-semibold text-foreground mt-6">3. 資訊的使用方式</h2>
                    <p>我們收集的資訊僅用於以下用途：</p>
                    <ul className="list-disc pl-5 space-y-2">
                    ...
                    <h2 className="text-xl font-semibold text-foreground mt-6">4. 資料包含與安全</h2>
                    <p>
                    ...
                    <h2 className="text-xl font-semibold text-foreground mt-6">5. 您的權利</h2>
                    <p>
                        您有權隨時要求刪除您的帳號及相關個人資料。
                        若需行使此權利，請透過 LINE 官方帳號與我們聯繫。
                    </p>

                    <h2 className="text-xl font-semibold text-foreground mt-6">6. 政策更新</h2>
                    <p>
