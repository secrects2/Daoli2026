        ...
        <div className="min-h-screen bg-background p-6">
            <div className="max-w-6xl mx-auto space-y-8">
                ...
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl font-bold text-foreground">比賽數據詳細報表</h1>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left text-sm text-gray-600">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {matches.map((match) => (
                                    <tr key={match.id} className="hover:bg-background transition-colors">
                                        ...
                                        <td className="p-4 text-center">
                                            <span className={`px-3 py-1 rounded-full text-xs font-bold 
                                                ${match.winner_color === 'red' ? 'bg-red-100 text-red-800' :
                                                    match.winner_color === 'yellow' ? 'bg-yellow-100 text-yellow-800' : 'bg-muted text-gray-600'}`}>
