...
export default function LoginPage() {
    return (
        <div className="min-h-screen relative overflow-hidden flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-background">
            ...
            <div className="relative z-10 w-full max-w-md animate-scale-in">
                ...
                {/* Clean White Card */}
                <div className="bg-card/80 backdrop-blur-xl shadow-xl border border-white/60 rounded-2xl p-8 sm:p-10 relative overflow-hidden">
