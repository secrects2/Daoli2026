...
export default function LoginForm() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Redirect based on role? For now just refresh/home
            router.refresh()
            router.push('/')
        } catch (err: any) {
        ...
        <div className="space-y-6">
            ...
            <div>
                <button
                    ...
                    className="ios-btn bg-[#00C300] hover:bg-[#00B300] focus-visible:outline-[#00C300]"
                >
            ...
            <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                    <span className="bg-white px-2 text-gray-500">或是藥師登入</span>
                </div>
            </div>
