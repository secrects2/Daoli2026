                ...
                <div className="mb-6">
                    <div className="relative">
                        <input
                            ...
                            placeholder={t('elders.searchPlaceholder')} // Updated
                            className="w-full md:w-96 pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900"
                        />
